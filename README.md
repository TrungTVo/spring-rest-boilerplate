...
- [**optimistic-lock**](https://github.com/TrungTVo/spring-rest-boilerplate/tree/optimistic-lock): Implement optimistic locking in Spring Data JPA to handle concurrent updates to the same entity, preventing data inconsistencies and ensuring data integrity.
